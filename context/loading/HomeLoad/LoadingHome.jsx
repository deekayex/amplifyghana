...
const LoadingHome = () => {
  return (
    ...
    <div className='playlist-component skeleton-playlist'>
    <p className='editor-text-header palylsit-skeleton-text-header'></p>
    <p className='editor-text-body palylsit-skeleton-text-body'></p>
    <p className='editor-text-body editor-skeleton-text-body2'></p>
    <p className='editor-text-body editor-skeleton-text-body3'></p>
    </div>
    </div>
