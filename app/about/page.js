    ...
    <section className="about_us_page" id="about">
      ...
      <div className="about_top">
        ...
        <div className="top_box">
          AMPLIFY GHANA IS AN ONLINE CREATIVE’S PROMOTION AND PUBLIC RELATIONS
          AGENCY FOUNDED IN 2020. OUR PRIMARY MISSION IS TO ELEVATE CREATIVES
          THROUGHOUT AFRICA, WITH A SPECIAL FOCUS ON GHANA, AS THAT IS WHERE WE
          ARE HEADQUARTERED.
        </div>
      </div>
