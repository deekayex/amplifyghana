      ...
      <div className="aside-articles">
        <div className="flex-aside-article">
          <Link
            ...
            style={{
              backgroundImage: `url(${
                highlightedNews ? highlightedNews.image : ""
              })`,
            }}
        ...
        <div className="flex-aside-article">
          <Link
            ...
            style={{
              backgroundImage: `url(${
                highlightedEditors ? highlightedEditors.image : ""
              })`,
            }}
            className="aside-article"
          >
          ...
          <div className="aside-article-side">
            <Link href={editorsLink} className="article-description">
              {highlightedEditors ? highlightedEditors.title : ""}
            </Link>
            <Link href="/#editors-pick" className="link-to-section">
        ...
        <div className="flex-aside-article">
          ...
          <div className="aside-playlist-side">
            ...
            <Link href="/playlists" className="link-to-section">
              See more Playlists
            </Link>
          </div>
        </div>
